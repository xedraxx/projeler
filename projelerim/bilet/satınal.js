document.addEventListener('DOMContentLoaded', function() {
    ...
    const flights = [
        ...
        { id: 28, from: 'Mersin', to: 'istanbul', date: '2024-10-20', price: '4380 TL', flightNumber: 'TK 3601', time: '19:15' },
        { id: 29, from: 'Konya', to: 'istanbul', date: '2024-10-20', price: '5380 TL', flightNumber: 'TK 3601', time: '19:15' },
        { id: 30, from: 'Kayseri', to: 'istanbul', date: '2024-10-20', price: '6580 TL', flightNumber: 'TK 3601', time: '19:15' }
    ];
    ...
    if (flight) {
        ...
        document.getElementById('purchase-form').addEventListener('submit', function(event) {
            ...
            if (!phonePattern.test(phone)) {
                alert('Telefon numarası geçersiz. Lütfen geçerli bir telefon numarası girin.');
                return;
            }
            ...
            if (name && email && phone) {
                ...
                alert('Lütfen tüm bilgileri doğru şekilde doldurduğunuzdan emin olun.');
            }
        });
    } else {
        document.getElementById('flight-details').innerHTML = '<p>Geçersiz uçuş ID.</p>';
    }
});
